...
# patsy auditory
patsy_a <- 'response ~ (1|sbj_id) + (1|block:sbj_id) + target_z + diff_z + stim_1_z  + resp_1_z*prev_diff_z + cue_z*PPS_z*block_type + resp_1_z*PPS_z*block_type_z'
...
# patsy visual
patsy_v <- 'response ~ (1|sbj_id) + (1|Block:sbj_id) + target_z + coherence_z + stim_1_z + resp_1_z*prev_coh_z + cue_z*PPS_z*block_type + resp_1_z*PPS_z*block_type_z'
