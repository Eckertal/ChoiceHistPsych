...
patsy_vis_noRS <- 'response ~ (1|sbj_id)  + (1|Block:sbj_id) + target_z + coherence_z + cue_z  + stim_1_z + resp_1_z * PPS_z + PPS_z * stim_1_z '
...
patsy_vis_RS <- 'response ~ (1|sbj_id) + (1|Block:sbj_id) + (1+cue_z|sbj_id) + (1+resp_1_z|sbj_id) + (1+stim_1_z|sbj_id) + target_z + coherence_z + stim_1_z + cue_z * PPS_z + resp_1_z * PPS_z '
...
patsy_RScue <- 'response ~ (1|sbj_id) + (1|Block:sbj_id) + (1+cue_z|sbj_id) + target_z + coherence_z + stim_1_z + cue_z * PPS_z + resp_1_z * PPS_z '
...
patsy_RS_rt1 <- 'response ~ (1|sbj_id) + (1|Block:sbj_id) + (1+resp_1_z|sbj_id) + target_z + coherence_z + stim_1_z + cue_z * PPS_z + resp_1_z * PPS_z '
...
patsy_RS_st1 <- 'response ~ (1|sbj_id) + (1|Block:sbj_id) + (1+stim_1_z|sbj_id) + target_z + coherence_z + stim_1_z + cue_z * PPS_z + resp_1_z * PPS_z '
