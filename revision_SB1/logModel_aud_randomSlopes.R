...
patsy_RS <- 'response ~ (1|sbj_id) + (1|block:sbj_id) + (1+cue_z|sbj_id) + (1+resp_1_z|sbj_id) + (1+stim_1_z|sbj_id) + target_z * evidence_z + stim_1_z*evi.1_z + cue_z*PPS_z*block_type_z + resp_1_z*PPS_z*block_type_z'
...
patsy_RScue <- 'response ~ (1|sbj_id) + (1|block:sbj_id) + (1+cue_z|sbj_id) + target_z*evidence_z + stim_1_z*evi.1_z + cue_z*PPS_z*block_type_z + resp_1_z*PPS_z*block_type_z'
...
patsy_RS_rt1 <- 'response ~ (1|sbj_id) + (1|block:sbj_id) + (1+resp_1_z|sbj_id) + target_z*evidence_z + stim_1_z*evi.1_z + cue_z*PPS_z*block_type_z + resp_1_z*PPS_z*block_type_z'
...
patsy_RS_st1 <- 'response ~ (1|sbj_id) + (1|block:sbj_id) + (1+stim_1_z|sbj_id) + target_z*evidence_z + stim_1_z*evi.1_z + cue_z*PPS_z*block_type_z + resp_1_z*PPS_z*block_type_z'
