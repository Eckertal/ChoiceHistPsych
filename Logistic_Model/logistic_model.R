...
# patsy auditory
patsy_aud <- 'response ~ (1|sbj_id) + (1|block:sbj_id) + target_z + evidence_z  + stim_1_z + resp_1_z*PPS_z*block_type_z + cue_z*PPS_z*block_type_z'
...
# patsy visual
patsy_vis <- 'response ~ (1|sbj_id)  + (1|Block:sbj_id) + target_z + coherence_z  + stim_1_z + resp_1_z*PPS_z*block_type_z + cue_z*PPS_z*block_type_z'
